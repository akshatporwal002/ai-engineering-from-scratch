...
class CodeologySkillMapTest(unittest.TestCase):
    ...
    def test_repository_learning_map_passes(self) -> None:
        self.assertEqual(validator.audit(self.html, self.script, self.css, self.ui_controls), [])
    ...
    def test_missing_assurance_note_is_rejected(self) -> None:
        ...
        errors = validator.audit(broken, self.script, self.css, self.ui_controls)
    ...
    def test_verified_local_state_is_rejected(self) -> None:
        ...
        errors = validator.audit(self.html, broken, self.css, self.ui_controls)
    ...
    def test_missing_header_clearance_is_rejected(self) -> None:
        ...
        errors = validator.audit(self.html, self.script, broken, self.ui_controls)
