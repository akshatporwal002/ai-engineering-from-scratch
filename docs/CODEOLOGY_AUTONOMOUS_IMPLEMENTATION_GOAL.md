...
- **Stage 2 — complete locally:** the shared shell centralizes Codeology product/source configuration, navigation, footer ownership and design tokens; rebrands the public chrome; adds persistent upstream attribution; and enforces pure white/black canvases with rounded/translucent controls. The homepage and About route explain the learn/build/prove proposition, open-tool policy, evidence boundary and non-endorsement relationship; the lesson reader carries a pinned-source badge; and the imported glossary, 503-lesson catalog and 20-phase learning map retain their core interaction contracts. The map distinguishes browser-local lesson activity from assessed skill evidence while supporting accessible progressive glow. Homepage, lesson, glossary, catalog and skill-map desktop-light/mobile-dark baselines are stored with deterministic provenance, semantics, interaction, responsive-layout and contrast validators.
- **Stage 3 — in progress:** assessment charter version 1 publishes stable learned, practised, demonstrated and verified definitions, anchored rubric language, the open-tool policy, separate artifact/identity/administration assurance axes and a deterministic policy-engine boundary. The public assurance guide is validated against the machine-readable policy and honestly caps the current product at learning activity. Strict v1 job-task-analysis, assessment-blueprint, pathway, skill, scenario, rubric and evidence schemas now enforce immutable references, acyclic skill graphs, multi-source research, multidisciplinary review, complete task/criterion/skill coverage, public/assessor separation and honest assurance ceilings. The scenario-authoring skill is aligned with those contracts and requires manual pilot evidence before automation. Selecting the target role, conducting its analysis and publishing the first 8–12-skill pilot pathway remain next.
